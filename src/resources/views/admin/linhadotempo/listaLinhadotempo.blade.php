              ...
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Linha do Tempo</h1></li>
                  </ol>
                </nav>
              </div>
            </div>
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body p-0">
                    <div class="table-responsive">
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          @forelse($listaLinhadotempo as $linhadotempo)
                          <tr>
                            {{-- ID --}}
                            <td>
                              {{ $linhadotempo->id_linha_tempo}}
                            </td>
                            {{-- Titulo --}}
                            <td>
                              {{ $linhadotempo->titulo_linha_tempo }}
                            </td>
                            {{-- Ano --}}
                            <td>
                              {{ $linhadotempo->ano_linha_tempo }}
                            </td>
                            {{-- Descrição --}}
                            <td>
                              {{ $linhadotempo->descricao_linha_tempo }}
                            </td>
                            {{-- Status --}}
                            <td>
                                @if($linhadotempo->status_linha_tempo === 'ATIVO')
                        ...
                        @empty
                          <tr>
                            <td colspan="5"
                              ...
                              Nenhuma linha de tempo inserida.
                            </td>
                          </tr>
                          @endforelse
                        </tbody>
                  ...
                  <div class="card-footer clearfix">
                    <div class="float-start pt-1 fs-7 text-body-secondary">
                      Total de cards da linha do tempo
                      <strong>
                        {{ $listaLinhadotempo->count() }}
                      </strong>
                    </div>
