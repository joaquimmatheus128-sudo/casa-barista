              ...
              <div class="col-sm-6">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb float-sm-end">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Produtos</h1></li>
                  </ol>
                </nav>
              </div>
            </div>
                      ...
                      <div class="col-12 col-md-8">
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          ...
                          >
                            ...
                            <option value="bebidas_geladas">Bebidas Geladas</option>
                      ...
                      <table class="table table-hover align-middle m-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {{-- Categoria --}}
                            <td>
                              {{ optional($produto->categoria)->nome_categoria ?? 'Sem categoria' }}
                            </td>
                            {{-- Destaque --}}
                            <td>
                            ...
                            <td>
                              ...
                              @else
                                <span class="badge text-bg-warming">
                                  Inativa
                                </span>
